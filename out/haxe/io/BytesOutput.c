...
int haxe_io_BytesOutput_writeBytes(haxe__io__BytesOutput r0,haxe__io__Bytes r1,int r2,int r3) {
	...
	int r5, r6;
	r6 = 0;
	if( r2 < r6 ) goto label$2250$8;
	r6 = 0;
	if( r3 < r6 ) goto label$2250$8;
	r5 = r2 + r3;
	if( r1 == NULL ) hl_null_access();
	r6 = r1->length;
	if( r6 >= r5 ) goto label$2250$10;
	label$2250$8:
	r7 = (venum*)global$808;
...
void haxe_io_BytesOutput_new(haxe__io__BytesOutput r0) {
	...
	r1 = (haxe__io__BytesBuffer)hl_alloc_obj(haxe__io__BytesBuffer__val);
