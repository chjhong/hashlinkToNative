...
HL_API vbyte* directx_compile_shader(vbyte*,int,vbyte*,vbyte*,vbyte*,int,bool*,int*);
HL_API vbyte* directx_get_device_name(void);
HL_API dx_driver* directx_create(dx_window*,int,int,int);
HL_API dx_pointer* directx_create_render_target_view(dx_resource*,vdynamic*);
HL_API dx_pointer* directx_create_rasterizer_state(vdynamic*);
HL_API bool directx_set_fullscreen_state(bool);
HL_API dx_pointer* directx_create_depth_stencil_state(vdynamic*);
HL_API void directx_generate_mips(dx_pointer*);
HL_API void directx_vs_set_shader_resources(int,int,dx_pointer**);
HL_API void directx_ps_set_shader_resources(int,int,dx_pointer**);
HL_API void directx_ps_set_samplers(int,int,dx_pointer**);
HL_API void directx_vs_set_samplers(int,int,dx_pointer**);
HL_API void directx_clear_depth_stencil_view(dx_pointer*,vdynamic*,vdynamic*);
HL_API void directx_om_set_depth_stencil_state(dx_pointer*,int);
HL_API dx_pointer* directx_create_depth_stencil_view(dx_resource*,int);
HL_API void directx_ia_set_vertex_buffers(int,int,dx_resource**,vbyte*,vbyte*);
HL_API void directx_ia_set_index_buffer(dx_resource*,bool,int);
HL_API void directx_ia_set_primitive_topology(int);
HL_API void directx_ps_set_constant_buffers(int,int,dx_resource**);
HL_API dx_resource* directx_create_buffer(int,int,int,int,int,int,vbyte*);
HL_API void directx_ps_set_shader(dx_pointer*);
HL_API void directx_vs_set_constant_buffers(int,int,dx_resource**);
HL_API void directx_vs_set_shader(dx_pointer*);
HL_API void directx_draw_indexed_instanced_indirect(dx_resource*,int);
HL_API void directx_draw_indexed(int,int,int);
HL_API void directx_release_pointer(dx_pointer*);
HL_API double directx_get_supported_version(void);
HL_API void directx_ia_set_input_layout(dx_pointer*);
HL_API void directx_present(int,int);
HL_API void directx_clear_color(dx_pointer*,double,double,double,double);
HL_API void directx_rs_set_scissor_rects(int,vbyte*);
HL_API dx_pointer* directx_create_input_layout(varray*,vbyte*,int);
HL_API dx_pointer* directx_create_blend_state(bool,bool,varray*,int);
HL_API void directx_rs_set_viewports(int,vbyte*);
HL_API void directx_rs_set_state(dx_pointer*);
HL_API void directx_om_set_render_targets(int,dx_pointer**,dx_pointer*);
HL_API void directx_om_set_blend_state(dx_pointer*,vbyte*,int);
HL_API dx_resource* directx_get_back_buffer(void);
HL_API bool directx_resize(int,int,int);
HL_API void directx_dispose_driver(dx_driver*);
HL_API bool directx_get_fullscreen_state(void);
HL_API void directx_set_error_handler(vclosure*);
HL_API void directx_destroy_cursor(dx_cursor*);
HL_API void directx_set_cursor(dx_cursor*);
HL_API void directx_show_cursor(bool);
HL_API dx_cursor* directx_load_cursor(int);
HL_API dx_cursor* directx_create_cursor(int,int,vbyte*,int,int);
HL_API void directx_win_clip_cursor(dx_window*);
HL_API bool directx_win_get_next_event(dx_window*,vdynamic*);
HL_API int directx_get_screen_height(void);
HL_API int directx_get_screen_width(void);
HL_API void directx_win_destroy(dx_window*);
HL_API void directx_win_get_position(dx_window*,int*,int*);
HL_API void directx_win_get_size(dx_window*,int*,int*);
HL_API void directx_win_resize(dx_window*,int);
HL_API void directx_win_set_position(dx_window*,int,int);
HL_API void directx_win_set_size(dx_window*,int,int);
HL_API void directx_win_set_fullscreen(dx_window*,bool);
HL_API void directx_win_set_title(dx_window*,vbyte*);
HL_API dx_window* directx_win_create(int,int);
HL_API void directx_release_resource(dx_resource*);
HL_API void directx_unmap(dx_resource*,int);
HL_API void directx_copy_subresource_region(dx_resource*,int,int,int,int,dx_resource*,int,vdynamic*);
HL_API void directx_update_subresource(dx_resource*,int,vdynamic*,vbyte*,int,int);
HL_API void directx_copy_resource(dx_resource*,dx_resource*);
HL_API vbyte* directx_map(dx_resource*,int,int,bool,int*);
HL_API vbyte* directx_detect_keyboard_layout(void);
HL_API void directx_debug_print(vbyte*);
HL_API dx_pointer* directx_create_shader_resource_view(dx_resource*,vdynamic*);
HL_API dx_pointer* directx_create_sampler_state(vdynamic*);
HL_API dx_resource* directx_create_texture_2d(vdynamic*,vbyte*);
HL_API dx_pointer* directx_create_pixel_shader(vbyte*,int);
HL_API dx_pointer* directx_create_vertex_shader(vbyte*,int);
HL_API vbyte* directx_disassemble_shader(vbyte*,int,int,vbyte*,int*);
